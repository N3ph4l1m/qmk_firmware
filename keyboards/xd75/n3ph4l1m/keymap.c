...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
     * | LCTRL  | LGUI   | LALT   | FN     | BACKSP | SPACE  | LEFT   | DOWN   | RIGHT  | ENTER  | TAB    | FN     | RALT   | RGUI   | RCTRL  |
     * '--------------------------------------------------------------------------------------------------------------------------------------'
     */
    [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
        ...
        KC_LCTL, KC_LGUI, KC_LALT, MO(_FN), KC_BSPC, KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_ENT,  KC_TAB,  MO(_FN), KC_RALT, KC_RGUI, KC_RCTL
    ),
